...
public enum ImgurTheme {
    IMGUR(R.style.Theme_Pokengur_Light_Imgur, R.style.Theme_Dark_Imgur, R.style.Theme_Dark_Amoled_Imgur, R.color.theme_imgur_primary, R.color.theme_imgur_dark, R.color.theme_imgur_accent),
    BLUE(R.style.Theme_Pokengur_Light_Blue, R.style.Theme_Dark_Blue, R.style.Theme_Dark_Amoled_Blue, R.color.theme_blue_primary, R.color.theme_blue_dark, R.color.theme_blue_accent),
    ORANGE(R.style.Theme_Pokengur_Light_Orange, R.style.Theme_Dark_Orange, R.style.Theme_Dark_Amoled_Orange, R.color.theme_orange_primary, R.color.theme_orange_dark, R.color.theme_light_blue_accent),
    CYAN(R.style.Theme_Pokengur_Light_Cyan, R.style.Theme_Dark_Cyan, R.style.Theme_Dark_Amoled_Cyan, R.color.theme_cyan_primary, R.color.theme_cyan_dark, R.color.theme_cyan_accent),
    GREEN(R.style.Theme_Pokengur_Light_Green, R.style.Theme_Dark_Green, R.style.Theme_Dark_Amoled_Green, R.color.theme_green_primary, R.color.theme_green_dark, R.color.theme_green_accent),
    TEAL(R.style.Theme_Pokengur_Light_Teal, R.style.Theme_Dark_Teal, R.style.Theme_Dark_Amoled_Teal, R.color.theme_teal_primary, R.color.theme_teal_dark, R.color.theme_teal_accent),
    RED(R.style.Theme_Pokengur_Light_Red, R.style.Theme_Dark_Red, R.style.Theme_Dark_Amoled_Red, R.color.theme_red_primary, R.color.theme_red_dark, R.color.theme_red_accent),
    PINK(R.style.Theme_Pokengur_Light_Pink, R.style.Theme_Dark_Pink, R.style.Theme_Dark_Amoled_Pink, R.color.theme_pink_primary, R.color.theme_pink_dark, R.color.theme_pink_accent),
    PURPLE(R.style.Theme_Pokengur_Light_Purple, R.style.Theme_Dark_Purple, R.style.Theme_Dark_Amoled_Purple, R.color.theme_purple_primary, R.color.theme_purple_dark, R.color.theme_purple_accent),
    GREY(R.style.Theme_Pokengur_Light_Grey, R.style.Theme_Dark_Grey, R.style.Theme_Dark_Amoled_Grey, R.color.theme_grey_primary, R.color.theme_grey_dark, R.color.theme_grey_accent),
    BLACK(R.style.Theme_Pokengur_Light_Black, R.style.Theme_Dark_Black, R.style.Theme_Dark_Amoled_Black, R.color.theme_black_primary, R.color.theme_black_dark, R.color.theme_black_accent);
